...
<div class="wrap">	
	...
	<div class="single">
			...
			<div class="span1_of_1">
				...
				<div class="product-view">
				    ...
				    <div class="product-image"> 
				       	<img src="images/<%=itemId %>.jpg" alt="Women Shorts" title="Women Shorts" height=300 width=auto/>
				   </div>
				</div>
				</div>
				</div>
			...
			<div class="span1_of_1_des">
				  <div class="desc1">
					<h3><%=itemDB.getName(itemId) %></h3>
					<p><%=itemDB.getDescription(itemId) %></p>
					<h5><%=itemDB.getPrice(itemId) %></h5>
					<div class="available">
					<div class="btn_form">
					<form action="addtocart?itemId=<%=itemId %>" method="post">
						<h4>参数 :</h4>
						<ul>
							<li>数量:
